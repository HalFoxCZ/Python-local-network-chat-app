    ...
    while True:
        ...
        try:
            ...
            if name in clientnames:
                ...
                logging.set(logging.get()+"\n"+"Connection attempt denied from: `"+str(addr)+"`, name: `"+name+"`")
            else:
                break
        except IndexError:
            print("Invalid login.")
    ...
    while True:
        try:
            ...
            if  b"||CLIENT||LOGIN||RESPONSE|?|" in msg.encode('ascii'):
                ...
                logging.set(logging.get()+"\n"+"Duplicate connection attempt denied from: `"+str(skt.getpeername())+"`, name: `"+name+"`")
                continue
            msg_send = name+": "+msg
            ...
            logging.set(logging.get()+"\n"+"Connection closed from: `"+str(skt.getpeername())+"`, name: `"+name+"`")
            break
